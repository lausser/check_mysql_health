...
foreach ($DS as $i) {
    ...
    if(preg_match('/^uptime$/', $NAME[$i])) {
        ...
        $def[$defcnt] = "";
        $def[$defcnt] .= "DEF:uptime=$rrdfile:$DS[$i]:AVERAGE:reduce=LAST " ;
    ...
    if(preg_match('/^index_usage_now$/', $NAME[$i])) {
        ...
        foreach ($DS as $ii) {
          if(preg_match('/^index_usage$/', $NAME[$ii])) {
            $def[$defcnt] .= "DEF:indexusage=$rrdfile:$DS[$ii]:AVERAGE:reduce=LAST " ;
          ...
          if(preg_match('/^index_usage_now$/', $NAME[$ii])) {
            $def[$defcnt] .= "DEF:indexusagenow=$rrdfile:$DS[$ii]:AVERAGE:reduce=LAST " ;
    ...
    if(preg_match('/^bufferpool_hitrate_now$/', $NAME[$i])) {
        ...
        foreach ($DS as $ii) {
          ...
          if(preg_match('/^bufferpool_hitrate_now$/', $NAME[$ii])) {
            $def[$defcnt] .= "DEF:hitratenow=$rrdfile:$DS[$ii]:AVERAGE:reduce=LAST " ;
    ...
    if(preg_match('/^bufferpool_free_waits_rate$/', $NAME[$i])) {
        ...
        $def[$defcnt] = "";
        $def[$defcnt] .= "DEF:logwait=$rrdfile:$DS[$i]:AVERAGE:reduce=LAST " ;
    ...
    if(preg_match('/^long_running_procs$/', $NAME[$i])) {
        ...
        $def[$defcnt] = "";
        $def[$defcnt] .= "DEF:longrun=$rrdfile:$DS[$i]:AVERAGE:reduce=LAST " ;
    ...
    if(preg_match('/^qcache_hitrate_now$/', $NAME[$i])) {
        ...
        foreach ($DS as $ii) {
          if(preg_match('/^selects_per_sec$/', $NAME[$ii])) {
            $def[$defcnt] .= "DEF:sps=$rrdfile:$DS[$ii]:AVERAGE:reduce=LAST " ;
    ...
    if(preg_match('/^qcache_lowmem_prunes_rate$/', $NAME[$i])) {
        ...
        $def[$defcnt] = "";
        $def[$defcnt] .= "DEF:prunes=$rrdfile:$DS[$i]:AVERAGE:reduce=LAST " ;
    ...
    if(preg_match('/^tablelock_contention_now$/', $NAME[$i])) {
        ...
        foreach ($DS as $ii) {
          if(preg_match('/^tablelock_contention$/', $NAME[$ii])) {
            $def[$defcnt] .= "DEF:tbllckcont=$rrdfile:$DS[$ii]:AVERAGE:reduce=LAST " ;
          ...
          if(preg_match('/^tablelock_contention_now$/', $NAME[$ii])) {
            $def[$defcnt] .= "DEF:tbllckcontnow=$rrdfile:$DS[$ii]:AVERAGE:reduce=LAST " ;
    ...
    if(preg_match('/^pct_tmp_table_on_disk_now$/', $NAME[$i])) {
        ...
        foreach ($DS as $ii) {
          if(preg_match('/^pct_tmp_table_on_disk$/', $NAME[$ii])) {
            ...
            $def[$defcnt] .= "DEF:tmptbldsk=$rrdfile:$DS[$ii]:AVERAGE:reduce=LAST " ;
          ...
          if(preg_match('/^pct_tmp_table_on_disk_now$/', $NAME[$ii])) {
            $def[$defcnt] .= "DEF:tmptbldsknow=$rrdfile:$DS[$ii]:AVERAGE:reduce=LAST " ;
